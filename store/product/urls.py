...
urlpatterns = [
    ...
    # path('categories/<category_id>/product/<product_id>', views.get_single_product, name="single_product"),
    path('product/<product_id>/', views.get_single_product, name="single_product"),
